...
namespace WizEdit
{
    public class CRC16
    {
        static private readonly ushort[] crc_table2 = new ushort[256] {
    ...
    0x8201, 0x42c0, 0x4380, 0x8341, 0x4100, 0x81c1, 0x8081, 0x4040
        ...
        static public ushort crc_ibm( byte [] ptr, int start, int len, ushort crc)
        {

            crc = (ushort)(~crc);
	        for (int i = 0; i<len; i++) {
		        byte c = ptr[i+start];
                crc = (ushort)((crc >> 8) ^ crc_table2[(crc ^ c) & 0x00ff]);
	        }
	        return (ushort)(~crc);
        }
